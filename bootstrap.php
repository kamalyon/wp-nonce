 ...
 */
define('WP_TESTS_DIR', '/Users/albertocollazo/Proyectos/workspaces/wordpress-dev/trunk/tests/phpunit/');

/**
 * The path to the main file of the plugin to test.
 */
define('TEST_PLUGIN_FILE', '/Users/albertocollazo/Proyectos/workspaces/wp-nonce/wp-nonce.php');
